  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2>${process.env.NEXT_PUBLIC_APP_NAME} - ${subject}</h2>
        <p>Hi there,</p>
        <p>${subject}</p>
        ...
        <p>${process.env.NEXT_PUBLIC_APP_NAME} Team</p>
      </div>
    `,
  };
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Thank you for contributing to ${process.env.NEXT_PUBLIC_APP_NAME}!</p>
        <p>${process.env.NEXT_PUBLIC_APP_NAME} Team</p>
      </div>
    `,
  };
